...
The C++ files were generated by [Blackmire](https://github.com/ActiveMesa/Blackmire) and then rewrited manually, cause current state of Blackmire is far from being fully functional. 
